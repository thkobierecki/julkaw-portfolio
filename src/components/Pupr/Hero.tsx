...
const RightSection = styled.div`
  ...
  max-height: 650px;
  flex: 1;
  background-image: url(../purpbg.svg);
    ...
    <HeroContainer>
      <LeftContainer>
        ...
        <SubHeading className={nunito.className}>
          Strona landingowa to idealne miejsce, aby przedstawić się potencjalnym
          klientom. Aby zrobić dobre pierwsze wrażenie całość brandingu przeszła
          odświeżenie - szczegóły poniżej!
        </SubHeading>
