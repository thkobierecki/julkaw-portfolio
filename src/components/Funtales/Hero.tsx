  ...
  return (
    <HeroContainer>
      <LeftContainer>
        ...
        <PageTitle className={nunito.className}>APLIKACJA MOBILNA</PageTitle>
        <Heading>
          <b>Funtales</b>
        </Heading>
        <SubHeading className={nunito.className}>
          Autorski projekt aplikacji dla dzieci z personalizowanymi bajkami.
          Zachęcam do zapoznania się ze wszystkimi elementami projektu jakie
          stworzyłam.
        </SubHeading>
        ...
        <Wrapper>
          ...
          <Image src={framer} alt="Framer" width={40} height={40} />
          <Image src={canva} alt="Canva" width={40} height={40} />
          <Image src={incscape} alt="Inscape" width={50} height={40} />
          <Image src={animator} alt="Animator" width={40} height={40} />
        </Wrapper>
      </LeftContainer>
      <RightSection>
        <Laptop
          image={{
            src: "../funtales_laptop.png",
            alt: "Funtales project",
          }}
        />
      </RightSection>
    </HeroContainer>
